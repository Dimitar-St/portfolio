      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-20 sm:py-24 lg:px-8 lg:py-28">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,1fr)_auto]">
          <div>
            ...
            <div className="mt-9 flex items-center gap-3 text-zinc-500">
          ...
          <div className="justify-self-start lg:justify-self-end">
            <Image
              ...
              height={320}
              priority
              className="h-36 w-36 rounded-full border border-zinc-200 object-cover shadow-sm sm:h-44 sm:w-44"
            />
          </div>
        </div>
      </div>
