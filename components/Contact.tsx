        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#0F4C45] transition hover:bg-teal-50"
            >
              <EmailIcon />
              {contact.ctaLabel}
            </a>
            ...
            {socialLinks.map((link) => (
              <a
                ...
                className="inline-flex h-11 items-center justify-center gap-2 rounded-full border border-white/25 px-4 text-sm font-medium text-white transition hover:border-white/50 hover:bg-white/10"
              >
